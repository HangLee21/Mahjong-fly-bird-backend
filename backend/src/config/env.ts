...
const EnvSchema = z.object({
  ...
  AI_ACTION_DELAY_MS: z.coerce.number().int().min(300).default(750),
  ...
  RESPONSE_TIMEOUT_MS: z.coerce.number().int().min(0).default(30000),
  ROOM_FINISHED_TTL_MS: z.coerce.number().int().min(0).default(600000),
  ROOM_ABANDONED_TTL_MS: z.coerce.number().int().min(0).default(43200000),
  ROOM_CLEANUP_INTERVAL_MS: z.coerce.number().int().min(1000).default(60000),
